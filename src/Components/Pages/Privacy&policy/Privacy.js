...
const Privacy = () => {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Hazi Madbar Ali Hasanai Dakhil Madrasha
            Alumni Association, shahjadpur,gulshan,vatara,dhaka-1212.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to হাজী মাদবর আলী হাচানিয়া দাখিল
            মাদ্রাসা প্রাক্তন ছাত্র ছাত্রী পরিষদ, accessible from{" "}
            <a
              href="https://hasania-alumni-association.web.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://hasania-alumni-association.web.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>By email: nushourav4@gmail.com</p>
        </li>
        <li>
          <p>
            ...
            <a
              ...
              target="_blank"
            >
              https://www.facebook.com/groups/hasania.alumni.association/
            </a>
          </p>
        </li>
        <li>
          <p>By phone number: +8101933343522</p>
        </li>
      </ul>
    </div>
  );
